...
const CLIENT_LOGOS = [
  { src: '/client-logos/allied.avif', alt: 'Allied Hotel & Resort client partner logo' },
  { src: '/client-logos/avicena.avif', alt: 'Avicena Medical Institute client partner logo' },
  { src: '/client-logos/belenia.avif', alt: 'Belenia Luxury Hotel client partner logo' },
  { src: '/client-logos/blocket.avif', alt: 'Blocket Tech client partner logo' },
  { src: '/client-logos/bzangmo.avif', alt: 'Bzangmo Hospitality client partner logo' },
  { src: '/client-logos/dhs.avif', alt: 'DHS Healthcare Services client partner logo' },
  { src: '/client-logos/ecoutourism.avif', alt: 'Eco Tourism Pakistan client partner logo' },
  { src: '/client-logos/fjwc.avif', alt: 'FJWC Enterprise client partner logo' },
  { src: '/client-logos/harriot.avif', alt: 'Harriot Hotel & Suites client partner logo' },
  { src: '/client-logos/hasansadpara.avif', alt: 'Hasan Sadpara Expedition client partner logo' },
  { src: '/client-logos/holiday-resort.avif', alt: 'Holiday Resort Skardu client partner logo' },
  { src: '/client-logos/ilyas.avif', alt: 'Ilyas Trading client partner logo' },
  { src: '/client-logos/klooma.avif', alt: 'Klooma Digital client partner logo' },
  { src: '/client-logos/mapseeker.avif', alt: 'Mapseeker GIS Technologies client partner logo' },
  { src: '/client-logos/mtp.avif', alt: 'MTP Logistics client partner logo' },
  { src: '/client-logos/nazararesort.avif', alt: 'Nazara Resort client partner logo' },
  { src: '/client-logos/noregna.avif', alt: 'Noregna Hospitality client partner logo' },
  { src: '/client-logos/northscape.avif', alt: 'Northscape Adventures client partner logo' },
  { src: '/client-logos/rinor.avif', alt: 'Rinor Engineering client partner logo' },
  { src: '/client-logos/rmc.avif', alt: 'RMC Clinical Center client partner logo' },
  { src: '/client-logos/summit.avif', alt: 'Summit Treks client partner logo' },
  { src: '/client-logos/tourmaker.avif', alt: 'Tourmaker Travel Agency client partner logo' },
  { src: '/client-logos/trans-karakoram.avif', alt: 'Trans Karakoram Enterprise client partner logo' },
  { src: '/client-logos/yakandbullcafe.avif', alt: 'Yak and Bull Cafe client partner logo' },
  { src: '/client-logos/yham.avif', alt: 'YHAM Foundation client partner logo' },
  { src: '/client-logos/zamitix.avif', alt: 'Zamitix Global client partner logo' }
];
