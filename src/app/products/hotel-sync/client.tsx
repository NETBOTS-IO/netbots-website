             ...
             <FaqAEO 
                ...
                faqs={[
                  ...
                  },
                  {
                    ...
                    answer: "HotelSync features a built-in integration that uses API gateway protocols (such as CallMeBot) to compile key daily hotel stats (total check-ins, sales revenue, F&B orders, cash book status) and send them directly as a text notification to the owner's WhatsApp number. You don't need any expensive API packages."
                  },
                  {
                    question: "Can we run HotelSync on multiple computers simultaneously?",
                    answer: "Yes. HotelSync can be easily set up in a Local Area Network (LAN) database configuration. This allows the reception desk, restaurant billing counter, manager's office, and accountant to work on different PCs while syncing instantly in real-time."
                  },
                  {
                    question: "Is staff training required to use the software?",
                    answer: "We designed HotelSync with extreme simplicity in mind. With clean menus, instant searches, and shortcuts, staff members with basic computer skills can learn how to check guests in, process billing, and take restaurant orders in under 30 minutes."
                  },
                  {
                    question: "How secure is our hotel data?",
                    answer: "Since your database resides locally on your machines, your data is completely private. HotelSync also includes configurable automatic local backups that can write database snapshots to secondary drives or local network folders every time the application closes."
                  },
                  {
                    question: "What are the hardware requirements to run HotelSync?",
                    answer: "HotelSync is highly optimized and lightweight. It runs smoothly on any basic computer with Windows 10 or 11, at least 4GB of RAM, and any standard Intel Core i3 or equivalent processor."
                  },
                  {
