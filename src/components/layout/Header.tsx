      ...
      <header className={styles.header}>
        <div className={styles.navContainer}>
          <Link href="/" className={styles.logo} style={{ display: 'flex', alignItems: 'center' }}>
            <Image src="/images/netbots-logo-original.avif" alt="NetBots — Software Engineering, AI Automation & Growth Marketing Agency" width={120} height={36} style={{ objectFit: 'contain' }} priority />
          </Link>
