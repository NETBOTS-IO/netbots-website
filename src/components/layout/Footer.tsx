          ...
          <div className={styles.linksGrid}>
            <div className={styles.brandCol}>
              <Link href="/" className={styles.logo} style={{ display: 'flex', alignItems: 'center' }}>
                <Image src="/images/netbots_logo_white.avif" alt="NetBots — Software Engineering, AI Automation & Growth Marketing Agency" width={120} height={36} style={{ objectFit: 'contain' }} />
              </Link>
              ...
              <div style={{ display: 'flex', gap: '1rem', marginTop: '1.5rem' }}>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="NetBots on Facebook"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="NetBots on Instagram"
                  style={{ color: '#94a3b8', transition: 'color 0.2s' }}
                  onMouseOver={(e) => e.currentTarget.style.color = '#0052ff'}
                  onMouseOut={(e) => e.currentTarget.style.color = '#94a3b8'}
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="NetBots on LinkedIn"
                  style={{ color: '#94a3b8', transition: 'color 0.2s' }}
                  onMouseOver={(e) => e.currentTarget.style.color = '#0052ff'}
                  onMouseOut={(e) => e.currentTarget.style.color = '#94a3b8'}
                >
